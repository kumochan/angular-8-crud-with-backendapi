                                                ...
                                                <div role="menu"
                                                    ...
                                                    <ul class="message-menu mCustomScrollbar _mCS_2 mCS-autoHide mCS_no_scrollbar"
                                                        ...
                                                        <div id="mCSB_2"
                                                             ...
                                                             tabindex="0" style="max-height: 230px;">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        <ul id="myTabedu1" class="tab-review-design">
                            <li class="active"><a href="#description">Edit Basic Information: {{ $customer->first_name }}</a></li>
                        </ul>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section">
                                            <div id="dropzone1" class="pro-ad">
                                                <form action="{{ action('Backend\CustomerController@edit') }}" method="POST"
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="form-group">
                                                                <input name="company" type="text" class="form-control"
                                                                       placeholder="Apple Inc." value="{{ $customer->company }}">
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group alert-up-pd">
                                                                <div class="dz-message needsclick download-custom">
                                                                    ...
                                                                    <p class="edudropnone"><span
                                                                                class="note needsclick">(This is just a demo dropzone. Selected image is <strong>not</strong> actually uploaded.)</span>
                                                                    </p>
